...
class mainForm ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.patientDataTable = wx.grid.Grid( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.RAISED_BORDER|wx.VSCROLL )
		...
		self.txtSchool = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.txtClass = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.txtStuNum = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.lblContactInfo = wx.StaticText( self.operationPanel, wx.ID_ANY, u"联系方式：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.lblContactInfo.Wrap( -1 )
		gbSizer1.Add( self.lblContactInfo, wx.GBPosition( 5, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txtContactInfo = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		gbSizer1.Add( self.txtContactInfo, wx.GBPosition( 5, 1 ), wx.GBSpan( 1, 1 ), wx.ALL|wx.EXPAND, 5 )
		
		self.lblMeasuredAngle = wx.StaticText( self.operationPanel, wx.ID_ANY, u"测量角度：", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.lblMeasuredAngle.Wrap( -1 )
		gbSizer1.Add( self.lblMeasuredAngle, wx.GBPosition( 6, 0 ), wx.GBSpan( 1, 1 ), wx.ALL, 5 )
		
		self.txtMeasuredAngle = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.txtDistrict = wx.TextCtrl( self.operationPanel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
